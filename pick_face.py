...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('E:\conda\envs\opencv-env\conda-meta\haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
     readPicSaveFace('D:\myProject\pictures\data\hong','D:\myProject\pictures\picTest','.jpg','.JPG','png','PNG')
